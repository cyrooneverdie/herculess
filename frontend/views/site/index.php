...
<section class="relative overflow-hidden bg-slate-900 h-[100vh]" data-purpose="hero-section" id="beranda">
  ...
  <div id="hero-bg-container" class="absolute inset-0 w-full h-full">
    <img id="hero-bg-0"
      class="hero-bg-img absolute inset-0 w-full h-full object-cover opacity-100 transition-opacity duration-1000"
      style="transform: scaleX(-1);" src="/img/hero.jpg" />
    <img id="hero-bg-1"
      class="hero-bg-img absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-1000"
    ...
    <div class="w-full px-6 sm:px-10 lg:px-16 relative flex flex-col justify-end h-full">
      ...
      <div class="flex flex-col lg:flex-row justify-between items-end w-full mt-auto z-20 pb-4 sm:pb-6 gap-8">
        ...
        <div class="flex items-end justify-start gap-2 sm:gap-4 w-full md:w-auto overflow-visible">
          <!-- Left Arrow -->
          <button id="hero-prev"
            class="w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-full bg-black/40 hover:bg-brand-gold text-white flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] backdrop-blur-md z-20 border-2 border-white hover:border-brand-gold hover:scale-110 mb-4 sm:mb-6"
          ...
          <div id="hero-card-row"
            class="relative w-[200px] sm:w-[550px] shrink-0 h-[220px] sm:h-[280px] overflow-hidden"
            ...
            <!-- Card 0 -->
            <div
              class="hero-card-wrapper absolute bottom-0 left-0 flex flex-col items-center gap-2 transition-all duration-500 ease-out origin-bottom w-[160px] sm:w-[200px]">
              <button
                class="hero-select-card shrink-0 rounded-xl overflow-hidden relative transition-all duration-500 ease-out cursor-pointer border-2 w-full h-[200px] sm:h-[240px] border-brand-gold ring-2 ring-brand-gold/50 shadow-[0_0_25px_rgba(212,175,55,0.4)] pointer-events-none"
                data-index="0">
                <img class="w-full h-full object-cover pointer-events-none" style="transform: scaleX(-1);"
                  src="/img/hero.jpg" />
                <div class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"></div>
              </button>
              <span
                class="hero-card-label text-xs font-semibold text-white/90 transition-opacity duration-300 whitespace-nowrap">Transform
                Body</span>
            </div>
            ...
            <div
              class="hero-card-wrapper absolute bottom-0 left-0 flex flex-col items-center gap-2 transition-all duration-500 ease-out origin-bottom w-[160px] sm:w-[200px]">
              <button
                class="hero-select-card shrink-0 rounded-xl overflow-hidden relative transition-all duration-500 ease-out cursor-pointer border-2 w-full h-[200px] sm:h-[240px] border-white/20 hover:border-white/50"
                data-index="1">
                <img class="w-full h-full object-cover pointer-events-none"
              ...
              <span
                class="hero-card-label text-[10px] font-medium text-white/50 transition-opacity duration-300 whitespace-nowrap">Push
                Limits</span>
            </div>
            ...
            <div
              ...
              <span
                class="hero-card-label text-[10px] font-medium text-white/50 transition-opacity duration-300 whitespace-nowrap">Elevate
                Routine</span>
            </div>
            ...
            <div
              ...
              <span
                class="hero-card-label text-[10px] font-medium text-white/50 transition-opacity duration-300 whitespace-nowrap">Battle
                Rope</span>
            </div>
            ...
            <div
              ...
              <span
                class="hero-card-label text-[10px] font-medium text-white/50 transition-opacity duration-300 whitespace-nowrap">Kickboxing</span>
            </div>
        ...
        <!-- Title & Info (Right) -->
        <div
          class="flex flex-col items-end gap-4 sm:gap-6 shrink-0 text-right z-10 max-w-[80%] sm:max-w-xl pointer-events-none">
          <div class="pointer-events-auto">
            <h1 id="hero-title"
              class="text-3xl sm:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.08] mb-4 transition-opacity duration-500 drop-shadow-2xl font-condensed uppercase">
              Tempat <span class="italic-serif font-normal text-brand-gold normal-case">Para Legenda</span> Tercipta
            </h1>
            <p id="hero-desc"
              class="text-sm sm:text-lg text-white/80 font-normal leading-relaxed max-w-md ml-auto transition-opacity duration-500 drop-shadow-md">
...
<section class="py-16 md:py-24 relative bg-gradient-to-b from-amber-100 via-amber-50/30 to-white"
  data-purpose="fasilitas-section" id="fasilitas">
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div class="flex flex-col items-center text-center gap-6 mb-12">
      ...
      <p class="text-slate-500 text-sm max-w-lg leading-relaxed">"Bukan sekadar tempat angkat beban, temukan ruang
        latihan yang suportif dan bikin betah."</p>
    </div>
  ...
  "></div>
    ...
    <div class="relative w-full overflow-hidden py-10">
      ...
      <div class="animate-marquee">
        ...
        <!-- Card 1 (Video) -->
        <div
          class="w-[280px] h-[400px] sm:w-[350px] sm:h-[500px] shrink-0 relative shadow-[0_10px_40px_rgba(0,0,0,0.6)] rounded-xl overflow-hidden flex flex-col group transition-transform duration-300 hover:scale-105 select-none mx-3">
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-[#121316] via-black/50 to-transparent pointer-events-none">
          </div>
          <div class="relative z-10 p-5 flex flex-col justify-end flex-grow text-white">
            ...
            <p class="text-xs text-gray-300 line-clamp-3 leading-relaxed">"Fasilitas lengkap dan vibes-nya mendukung
              banget buat fokus latihan beban. Udah 6 bulan gabung, progress kerasa banget!"</p>
          </div>
        </div>
        ...
        <div
          class="w-[280px] h-[400px] sm:w-[350px] sm:h-[500px] shrink-0 relative shadow-[0_10px_40px_rgba(0,0,0,0.6)] rounded-xl overflow-hidden flex flex-col group transition-transform duration-300 hover:scale-105 select-none mx-3">
          <img alt="Member Workout" class="absolute inset-0 w-full h-full object-cover transition duration-700"
            src="/img/clip4.jpeg" />
          <div class="absolute inset-0 bg-black/40 transition duration-700 pointer-events-none"></div>
          <div class="absolute inset-0 bg-gradient-to-t from-[#121316] via-black/50 to-transparent pointer-events-none">
          </div>
          <div class="relative z-10 p-5 flex flex-col justify-end flex-grow text-white">
            ...
            <p class="text-xs text-gray-300 line-clamp-3 leading-relaxed">"Tempatnya asik buat workout sambil ketemu
              temen-temen baru. Kelasnya seru dan instrukturnya super ramah."</p>
          </div>
        </div>
        ...
        <div
          ...
          <div class="relative z-10 p-5 flex flex-col justify-end flex-grow text-white">
            ...
            <p class="text-xs text-gray-300 line-clamp-3 leading-relaxed">"Suka banget cardio disini, peralatannya
              premium dan pemandangannya bikin semangat lari terus."</p>
          </div>
        </div>
        ...
        <div
          ...
          <div class="relative z-10 p-5 flex flex-col justify-end flex-grow text-white">
            ...
            <p class="text-xs text-gray-300 line-clamp-3 leading-relaxed">"Suasananya asri dan tenang. Area
              fungsionalnya luar biasa luas buat HIIT atau sekadar peregangan santai."</p>
          </div>
        </div>
        ...
        <div
          ...
          <div class="relative z-10 p-5 flex flex-col justify-end flex-grow text-white">
            ...
            <p class="text-xs text-brand-gold font-medium mb-2">Member VIP - Cabang Batu Ampar</p>
            <p class="text-xs text-gray-300 line-clamp-3 leading-relaxed">"Peralatannya benar-benar standar profesional.
              Saya bisa mencapai personal best baru berkat alat yang mumpuni di sini."</p>
          </div>
        </div>
        ...
        <div
          ...
          <div class="relative z-10 p-5 flex flex-col justify-end flex-grow text-white">
            ...
            <p class="text-xs text-gray-300 line-clamp-3 leading-relaxed">"Langganan bareng bestie selalu bikin motivasi
              nge-gym ga pernah luntur. Loker room-nya pw banget!"</p>
          </div>
        </div>
        ...
        <div
          ...
          <video autoplay loop muted playsinline
            class="absolute inset-0 w-full h-full object-cover transition duration-700">
            <source
              src="https://assets.mixkit.co/videos/preview/mixkit-young-woman-running-on-a-treadmill-at-the-gym-44163-large.mp4"
              type="video/mp4">
          </video>
          <div class="absolute inset-0 bg-black/40 transition duration-700 pointer-events-none"></div>
          <div class="absolute inset-0 bg-gradient-to-t from-[#121316] via-black/50 to-transparent pointer-events-none">
        ...
        <div
          ...
          <video autoplay loop muted playsinline
            class="absolute inset-0 w-full h-full object-cover transition duration-700">
            <source
              src="https://assets.mixkit.co/videos/preview/mixkit-strong-man-lifting-heavy-barbell-in-gym-44161-large.mp4"
              type="video/mp4">
          </video>
          <div class="absolute inset-0 bg-black/40 transition duration-700 pointer-events-none"></div>
          <div class="absolute inset-0 bg-gradient-to-t from-[#121316] via-black/50 to-transparent pointer-events-none">
...
<section class="bg-[#0E0F13] relative" data-purpose="why-hercules-fitness-centre" id="mengapa">
  ...
  <div class="absolute inset-0 z-0 overflow-hidden pointer-events-none">
    ...
    <div class="sticky top-0 w-full h-screen">
      ...
      <div
        class="absolute top-0 left-0 w-[500px] sm:w-[800px] h-[500px] sm:h-[800px] bg-slate-500/10 rounded-full blur-[100px] sm:blur-[150px] -translate-x-1/2 -translate-y-1/4">
      </div>
      <!-- Right Side: Soft Orange Glow -->
      <div
        class="absolute top-1/2 right-0 w-[600px] sm:w-[900px] h-[600px] sm:h-[900px] bg-brand-gold/10 rounded-full blur-[120px] sm:blur-[180px] translate-x-1/3 -translate-y-1/2">
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 pt-24 md:pt-32 pb-16">
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
      ...
      <p class="text-slate-400 text-sm sm:text-base leading-relaxed max-w-sm lg:text-right">
        Kami bukan sekadar gym biasa — ekosistem fitness terlengkap yang mendukung perjalanan sehat Anda dari awal
        hingga hasil nyata.
      </p>
    </div>
  </div>
  ...
  <div id="why-stacking-container" class="relative max-w-7xl mx-auto px-6">
    ...
    <div class="why-stack-wrapper sticky top-16 h-[85vh] mb-6" style="z-index:1;">
      <div
        class="why-stack-card w-full h-full relative rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)] origin-top">
        <img
        ...
        <div class="relative h-full flex flex-col justify-between p-8 sm:p-12 lg:p-16">
          ...
          <div class="max-w-lg">
            ...
            <p class="text-white/70 text-sm sm:text-base leading-relaxed mb-8 max-w-md">
              Setiap anggota dipandu oleh instruktur berlisensi AAAI-ISFI &amp; ACE dengan pengalaman lebih dari 5
              tahun. Bukan hanya latihan — tapi pendampingan menyeluruh untuk hasil terbaik Anda.
            </p>
    ...
    <div class="why-stack-wrapper sticky top-16 h-[85vh] mb-6" style="z-index:3;">
      <div
        class="why-stack-card w-full h-full relative rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)] origin-top">
        <img src="/img/whyinfitnova.jpg" alt="Active Community"
          class="absolute inset-0 w-full h-full object-cover object-center scale-105" />
        ...
        <div class="relative h-full flex flex-col justify-between p-8 sm:p-12 lg:p-16">
          ...
          <div class="max-w-lg">
            ...
            <p class="text-white/70 text-sm sm:text-base leading-relaxed mb-8 max-w-md">
              Bergabung dengan komunitas fitness terbesar di kota ini. Group workout mingguan, challenge bulanan
              berhadiah, dan social run bersama setiap akhir pekan.
            </p>
            <div class="flex items-center gap-6">
              <div class="text-center">
    ...
    <div class="why-stack-wrapper sticky top-16 h-[85vh] mb-12" style="z-index:4;">
      <div
        class="why-stack-card w-full h-full relative rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)] origin-top">
        <img
          src="https://images.unsplash.com/photo-1576678927484-cc907957088c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1400&q=80"
          alt="Measurable Results Dashboard"
          class="absolute inset-0 w-full h-full object-cover object-center scale-105" />
        ...
        <div class="relative h-full flex flex-col justify-between p-8 sm:p-12 lg:p-16">
          ...
          <div class="max-w-lg">
            ...
            <p class="text-white/70 text-sm sm:text-base leading-relaxed mb-8 max-w-md">
              Pantau kalori, berat badan, kekuatan otot, dan VO2 max Anda secara real-time melalui dashboard Hercules
              Fitness yang terhubung langsung ke smartwatch dan smart band Anda.
            </p>
            <div class="flex items-center gap-6">
              <div class="text-center">
...
<section class="bg-[#0b0c10] text-white h-screen overflow-hidden relative" data-purpose="workout-showcase" id="layanan">
  ...
  <div id="services-intro"
    ...
    <p
      class="text-slate-200 text-sm md:text-base leading-relaxed mb-8 drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] max-w-lg text-center font-medium">
  ...
  <div class="absolute inset-0 w-full h-full">
    ...
    <div id="diag-panel-1" class="absolute inset-0 overflow-hidden"
      style="clip-path: polygon(0% 0%, 30% 0%, 20% 100%, 0% 100%); -webkit-clip-path: polygon(0% 0%, 30% 0%, 20% 100%, 0% 100%); z-index: 10;">
      <div id="diag-overlay-1" class="absolute inset-0 bg-black/60 z-10 pointer-events-none"></div>
      <img alt="Personal Training" class="absolute inset-0 w-full h-full object-cover object-center"
        src="https://lh3.googleusercontent.com/aida-public/AB6AXuCvTcFSvgH3D6K12uLcg-FiNkQZGpcELAtSngnakOFabKg7txyXohqGpvXYiEkokL07B7OQHh4FoNqpiueatLVZswgi1PJR2AkbTzsKmEURHlZWsi5HHRRE0Qw1phl_f8RNbZI0aVLsUC93ySJnFi914dgcf7GfFVAtfxg1ffHiJIAQ-GzVwc8NzWlGZVHYlCcwQ4d-yEvwNO66FVPOK5hZKX1LVd-OY6xekYJxxFXUghmRoONYfRhc1w" />
      <!-- Permanent Scrim for Text Legibility -->
      <div
        class="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-tr from-black/90 via-black/40 to-transparent z-10 pointer-events-none">
      </div>

      <div id="diag-content-1"
        class="absolute bottom-16 sm:bottom-32 left-8 sm:left-16 lg:left-32 opacity-0 translate-y-10 w-full max-w-sm z-20">
        <span
    ...
    <div id="diag-panel-2" class="absolute inset-0 overflow-hidden"
      style="clip-path: polygon(31% 0%, 55% 0%, 45% 100%, 21% 100%); -webkit-clip-path: polygon(31% 0%, 55% 0%, 45% 100%, 21% 100%); z-index: 20;">
      <div id="diag-overlay-2" class="absolute inset-0 bg-black/60 z-10 pointer-events-none"></div>
      <img alt="Nutrition Plans" class="absolute inset-0 w-full h-full object-cover object-center"
        src="https://lh3.googleusercontent.com/aida-public/AB6AXuDTZLsNojdfpcgtMvCBd9K3cyaRPllgaNOwHa2QMdJqJA0NzL2nFFWbJJmzJh4W3H4tjIIXOu6pRKJIILn0zr5lr99kvSCim-cGqR1ejOTyvN3rllUx9J8kv03JPrYdTRkuW7HuYx9Xc3zOBeRP-1V8fCslzXVjEJMgXZv78yCrYHqwRkIsSmehUplZPIKGNypMj4KuwnUU0qZpPg82Ap3VHujtNbqmwDPlrF62d8yOwiBQ6FOX0dmxkA" />
      <!-- Permanent Scrim for Text Legibility -->
      <div
        class="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-tr from-black/90 via-black/40 to-transparent z-10 pointer-events-none">
      </div>

      <div id="diag-content-2"
        class="absolute bottom-16 sm:bottom-32 left-8 sm:left-16 lg:left-32 opacity-0 translate-y-10 w-full max-w-sm z-20">
        <span
    ...
    <div id="diag-panel-3" class="absolute inset-0 overflow-hidden"
      style="clip-path: polygon(56% 0%, 80% 0%, 70% 100%, 46% 100%); -webkit-clip-path: polygon(56% 0%, 80% 0%, 70% 100%, 46% 100%); z-index: 30;">
      <div id="diag-overlay-3" class="absolute inset-0 bg-black/60 z-10 pointer-events-none"></div>
      <img alt="Yoga and Mindfulness" class="absolute inset-0 w-full h-full object-cover object-center"
        src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1400&q=80" />
      <!-- Permanent Scrim for Text Legibility -->
      <div
        class="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-tr from-black/90 via-black/40 to-transparent z-10 pointer-events-none">
      </div>

      <div id="diag-content-3"
        class="absolute bottom-16 sm:bottom-32 left-8 sm:left-16 lg:left-32 opacity-0 translate-y-10 w-full max-w-md z-20">
        <span
    ...
    <div id="diag-panel-4" class="absolute inset-0 overflow-hidden"
      style="clip-path: polygon(81% 0%, 100% 0%, 100% 100%, 71% 100%); -webkit-clip-path: polygon(81% 0%, 100% 0%, 100% 100%, 71% 100%); z-index: 40;">
      <div id="diag-overlay-4" class="absolute inset-0 bg-black/60 z-10 pointer-events-none"></div>
      <img alt="Cardio & Endurance" class="absolute inset-0 w-full h-full object-cover object-center"
...
<section class="bg-[#F3F6F8] relative overflow-hidden" data-purpose="how-it-works" id="how-it-works"
  ...
  <div class="max-w-7xl mx-auto px-6 w-full py-12">
    ...
    <div class="flex flex-col md:flex-row gap-10 md:gap-20 items-center relative h-full">
      ...
      <div class="w-full md:w-1/2 rounded-3xl overflow-hidden aspect-[4/3] bg-slate-100 shadow-2xl relative"
        id="hiw-image-container">
        <img src="https://images.unsplash.com/photo-1512428559087-560fa5ceab42?w=800&q=80" alt="Step 1"
          class="absolute inset-0 w-full h-full object-cover hiw-img opacity-100" data-step="0">
        <img src="/img/barcode.jpeg" alt="Step 2" class="absolute inset-0 w-full h-full object-cover hiw-img opacity-0"
          data-step="1">
        <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&q=80" alt="Step 3"
          class="absolute inset-0 w-full h-full object-cover hiw-img opacity-0" data-step="2">
      </div>
      ...
      <div class="w-full md:w-1/2 relative py-4" id="hiw-steps-container">
        <!-- Vertical Line Track -->
        <div
          class="absolute left-[28px] md:left-[38px] top-8 bottom-8 w-1 bg-slate-200 hidden md:block rounded-full z-0">
        </div>
        <!-- Progress Line (Animated) -->
        <div
          class="absolute left-[28px] md:left-[38px] top-8 w-1 bg-brand-gold hidden md:block origin-top rounded-full z-0"
          id="hiw-progress-line" style="height: 0%;"></div>

        <!-- Step 1 -->
        <div class="hiw-step flex gap-6 md:gap-8 mb-12 md:mb-16 relative z-10 opacity-100" data-step="0">
          <div
            class="w-14 h-14 md:w-20 md:h-20 rounded-2xl bg-[#fefce8] border border-[#fef08a] flex items-center justify-center shrink-0 shadow-sm hiw-icon-container relative">
        ...
        <div class="hiw-step flex gap-6 md:gap-8 mb-12 md:mb-16 relative z-10 opacity-30" data-step="1">
          <div
            class="w-14 h-14 md:w-20 md:h-20 rounded-2xl bg-white border border-slate-200 flex items-center justify-center shrink-0 shadow-sm hiw-icon-container relative">
...
<section class="py-20 md:py-32 bg-[#121316] relative overflow-hidden group" data-purpose="faq-section" id="faq">
  ...
  <div class="max-w-4xl mx-auto px-6 relative z-10">
    ...
    <div class="space-y-4">
      <!-- FAQ Item 1 -->
      <div
        class="faq-item border border-white/20 rounded-xl overflow-hidden transition-colors duration-300 hover:border-brand-gold/50 bg-[#1a1c23]">
        <button class="faq-button w-full flex items-center justify-between p-6 text-left focus:outline-none"
          ...
          <svg class="faq-icon w-6 h-6 text-white shrink-0 transition-transform duration-300" fill="none"
        ...
        <div class="faq-answer grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-in-out">
          <div class="overflow-hidden">
            <div class="px-6 pb-6 text-slate-400 text-sm leading-relaxed">
              Pakaian olahraga yang nyaman, sepatu khusus olahraga (sebaiknya sepatu training), handuk kecil untuk
              keringat, dan botol minum. Jangan lupa membawa gembok kecil jika Anda ingin menggunakan loker kami.
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        <div class="faq-answer grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-in-out">
          <div class="overflow-hidden">
            <div class="px-6 pb-6 text-slate-400 text-sm leading-relaxed">
              Untuk pemula, kami menyarankan 2-3 kali seminggu dengan durasi 45-60 menit per sesi. Hal ini penting agar
              otot tubuh Anda memiliki waktu yang cukup untuk beradaptasi dan melakukan pemulihan.
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        <div class="faq-answer grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-in-out">
          <div class="overflow-hidden">
            <div class="px-6 pb-6 text-slate-400 text-sm leading-relaxed">
              Tidak wajib, namun <strong>sangat disarankan</strong> di bulan pertama. Personal Trainer akan membantu
              Anda mempelajari postur tubuh yang benar, cara menggunakan alat yang aman, serta menyusun program latihan
              yang sesuai dengan target Anda untuk mencegah cedera.
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        <button class="faq-button w-full flex items-center justify-between p-6 text-left focus:outline-none"
          onclick="toggleFaq(this)">
          <span class="font-bold text-white text-lg">Badan saya terasa sangat sakit setelah latihan, apakah itu
            normal?</span>
          <svg class="faq-icon w-6 h-6 text-white shrink-0 transition-transform duration-300" fill="none"
            stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
        ...
        <div class="faq-answer grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-in-out">
          <div class="overflow-hidden">
            <div class="px-6 pb-6 text-slate-400 text-sm leading-relaxed">
              Sangat normal! Ini disebut <em>DOMS (Delayed Onset Muscle Soreness)</em>, biasa terjadi 24-48 jam setelah
              otot menerima stimulasi baru. Istirahatlah yang cukup, perbanyak minum air, penuhi asupan protein, dan
              rasa sakit tersebut perlahan akan hilang seiring tubuh Anda beradaptasi.
            </div>
          </div>
        </div>
      </div>
...
<section class="py-16 md:py-24 bg-[#f8f9fa] relative overflow-hidden" data-purpose="instagram-feed">
  ...
  <div id="ig-grid-container"
    class="w-full h-[500px] md:h-[600px] relative overflow-hidden shadow-[0_-15px_40px_rgba(212,175,55,0.3),_0_15px_40px_rgba(212,175,55,0.3)] z-20">
    <!-- Skewed Flex Container -->
    <div class="flex w-full h-full transform -skew-x-[8deg] scale-[1.05]">

      <!-- Post 1 -->
      <a href="https://instagram.com" target="_blank"
        class="ig-grid-item group relative flex-1 hover:flex-[3] overflow-hidden border-r-[3px] border-white cursor-pointer bg-slate-900"
        style="transition: flex 0.5s cubic-bezier(0.25,1,0.5,1);">
        ...
        <div class="absolute top-0 bottom-0 left-[-25%] w-[150%] transform skew-x-[8deg]">
          <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&q=80"
            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="IG 1">
          <!-- Overlay -->
          <div
            class="absolute inset-0 bg-black/50 transition-colors duration-500 group-hover:bg-gradient-to-t group-hover:from-black/90 group-hover:via-black/40 group-hover:to-transparent">
          </div>
        </div>
        <!-- Hover Content -->
        <div
          class="absolute inset-0 flex flex-col justify-end px-10 md:px-14 py-6 md:py-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 transform skew-x-[8deg]">
          <div class="translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-100">
            ...
            <p class="text-slate-200 text-sm md:text-base leading-relaxed line-clamp-2 md:line-clamp-3 mb-4">Push your
              limits today! 💪 Mulai perjalanan fitness Anda bersama kami dengan peralatan standar internasional.</p>
      ...
      <a href="https://instagram.com" target="_blank"
        ...
        <div class="absolute top-0 bottom-0 left-[-25%] w-[150%] transform skew-x-[8deg]">
          <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&q=80"
            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="IG 2">
          <div
            class="absolute inset-0 bg-black/50 transition-colors duration-500 group-hover:bg-gradient-to-t group-hover:from-black/90 group-hover:via-black/40 group-hover:to-transparent">
          </div>
        </div>
        <div
          ...
          <div class="translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-100">
            <span class="font-extrabold text-white text-lg block mb-2">@herculesfitness</span>
            <p class="text-slate-200 text-sm md:text-base leading-relaxed line-clamp-2 md:line-clamp-3 mb-4">Area beban
              yang luas menanti Anda. Tidak perlu lagi antri alat saat jam sibuk! 🔥</p>
            <div class="flex items-center text-xs text-[#fcb045] font-bold">
              <i class="fab fa-instagram text-xl mr-2"></i> View on Instagram
            </div>
          </div>
      ...
      <a href="https://instagram.com" target="_blank"
        ...
        <div class="absolute top-0 bottom-0 left-[-25%] w-[150%] transform skew-x-[8deg]">
          <img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&q=80"
            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="IG 3">
          <div
            class="absolute inset-0 bg-black/50 transition-colors duration-500 group-hover:bg-gradient-to-t group-hover:from-black/90 group-hover:via-black/40 group-hover:to-transparent">
          </div>
        </div>
        <div
          ...
          <div class="translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-100">
            <span class="font-extrabold text-white text-lg block mb-2">@herculesfitness</span>
            <p class="text-slate-200 text-sm md:text-base leading-relaxed line-clamp-2 md:line-clamp-3 mb-4">Butuh
              bimbingan? Personal Trainer kami siap merancang program khusus untuk goal spesifik Anda! 🎯</p>
            <div class="flex items-center text-xs text-[#fcb045] font-bold">
              <i class="fab fa-instagram text-xl mr-2"></i> View on Instagram
            </div>
          </div>
      ...
      <a href="https://instagram.com" target="_blank"
        ...
        style="transition: flex 0.5s cubic-bezier(0.25,1,0.5,1);">
        <div class="absolute top-0 bottom-0 left-[-25%] w-[150%] transform skew-x-[8deg]">
          <img src="https://images.unsplash.com/photo-1540497077202-7c8a3999166f?w=800&q=80"
            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="IG 4">
          <div
            class="absolute inset-0 bg-black/50 transition-colors duration-500 group-hover:bg-gradient-to-t group-hover:from-black/90 group-hover:via-black/40 group-hover:to-transparent">
          </div>
        </div>
        <div
          ...
          <div class="translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-100">
            <span class="font-extrabold text-white text-lg block mb-2">@herculesfitness</span>
            <p class="text-slate-200 text-sm md:text-base leading-relaxed line-clamp-2 md:line-clamp-3 mb-4">Kelas
              BodyPump malam ini PECAH banget! 🎉 Terima kasih buat semua member yang sudah hadir.</p>
            <div class="flex items-center text-xs text-[#fcb045] font-bold">
              <i class="fab fa-instagram text-xl mr-2"></i> View on Instagram
            </div>
          </div>
      ...
      <a href="https://instagram.com" target="_blank"
        class="ig-grid-item group relative flex-1 hover:flex-[3] overflow-hidden cursor-pointer bg-slate-900"
        style="transition: flex 0.5s cubic-bezier(0.25,1,0.5,1);">
        <div class="absolute top-0 bottom-0 left-[-25%] w-[150%] transform skew-x-[8deg]">
          <img src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=800&q=80"
            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="IG 5">
          <div
            class="absolute inset-0 bg-black/50 transition-colors duration-500 group-hover:bg-gradient-to-t group-hover:from-black/90 group-hover:via-black/40 group-hover:to-transparent">
          </div>
        </div>
        <div
          ...
          <div class="translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-100">
            <span class="font-extrabold text-white text-lg block mb-2">@herculesfitness</span>
            <p class="text-slate-200 text-sm md:text-base leading-relaxed line-clamp-2 md:line-clamp-3 mb-4">Never skip
              leg day! 🦵🔥 Mesin leg press baru sudah mendarat di cabang Batu Ampar.</p>
            <div class="flex items-center text-xs text-[#fcb045] font-bold">
              <i class="fab fa-instagram text-xl mr-2"></i> View on Instagram
            </div>
          </div>
  ...
  <div id="ig-btn-wrap" class="text-center mt-12 md:mt-16 px-6 relative z-10">
    <a href="https://www.instagram.com/hercules.fitnesscentre/" target="_blank"
      class="group relative overflow-hidden inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-[#D4AF37] text-slate-900 text-sm font-extrabold tracking-widest uppercase transition-all duration-300 shadow-[0_4px_15px_rgba(212,175,55,0.4)] hover:shadow-[0_6px_25px_rgba(212,175,55,0.6)] hover:-translate-y-1">
      <span class="absolute inset-0 flex items-center justify-center pointer-events-none">
        <span
          class="w-64 h-64 rounded-full bg-black/20 scale-0 group-hover:scale-100 transition-transform duration-500 ease-out z-0"></span>
      </span>
