...
<head>
    ...
    <title style="margin-bottom: 30px;">Riwayat berlangganan</title>
    <style>
...
<body>
    <button class="no-print" onclick="window.print()" style="margin-bottom: 20px;">Print Riwayat</button>
    ...
    <div class="invoice-container">
        ...
        <!-- <div class="date-info">
            <table class="date-table">
                <tr>
                    <td>TANGGAL</td>
                    <td>?= Yii::$app->formatter->asDate($histories->trandate, 'dd/MM/yyyy') ?></td>
                </tr>
                <tr>
                    <td>TGL. JATUH TEMPO</td>
                    <td>
                        ?php
                        $dueDate = $histories->tranduedate ? $histories->tranduedate : date('Y-m-d', strtotime('+7 days', strtotime($model->trandate)));
        ...
        <div class="bill-to-section">
            ...
            <div class="bill-to-content">
                <?= !empty($histories[0]['name']) ? $histories[0]['name'] : 'Arif sanjaya purnama' ?><br>
            ...
            <tbody>
                <?php foreach ($histories as $history): ?>
                    <tr>
                        <td>
                            <?php
                            if ($history['package'] == 'Free' || $history['subs_status'] == 10) {
                                echo "<span class='badge badge-secondary'>Free</span>";
                            } elseif ($history['package'] == 'Basic') {
                                echo "<span class='badge badge-primary'>Basic</span>";
                            } elseif ($history['package'] == 'Advanced') {
                                echo "<span class='badge badge-info'>Advanced</span>";
                            } elseif ($history['package'] == 'Enterprise') {
                                echo "<span class='badge badge-warning'>Enterprise</span>";
                            } else {
                                echo "-";
                            }
                            ?>
                        ...
                        <td>
                            <?= "Rp." . number_format($history['subtotal'], 0, ',', '.'); ?>
                        </td>
                        <td><?= Html::encode($history['tglstartsubs']) ?></td>
                        <td>
                            <?php
                            if (empty($history['statuspaid'])) {
