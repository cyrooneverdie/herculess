								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_673c0c9b689d9">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_673c0c9b689d9" data-allow-clear="true">
																<option></option>
										...
										<div class="card-body pt-9 pb-0">
											...
											<div class="me-7 mb-4">
												<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
													...
													<img src="<?= Yii::$app->user->identity->avatar ? Yii::$app->user->identity->avatar : Yii::getAlias('@web') . '/assets/media/avatars/default-avatar.jpg' ?>" alt="image" />
											...
											<!-- end::Pic -->
												...
												<div class="flex-grow-1">
													...
													<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
														...
														<div class="d-flex flex-column">
															...
															<a href="#" class="text-gray-700 text-hover-primary fs-2 fw-bold me-1">
												...
												<!-- end::Info -->
															...
															<div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
																<a href="#" class="d-flex  text-gray-500 text-hover-primary me-5 mb-2">
																...
																<i class="ki-duotone ki-geolocation fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																</i>Yokohama, Bay Area</a>
																<a href="#" class="d-flex text-gray-500 text-hover-primary mb-2">
											...
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												...
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="<?php echo Url::to(['contact/index'], true); ?>">Overview</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/settings'], true); ?>">Settings</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/security'], true); ?>">Security</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/activity'], true); ?>">Activity</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/billing'], true); ?>">Billing</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/statements'], true); ?>">Statements</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/referrals'], true); ?>">Referrals</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/api-keys'], true); ?>">API Keys</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo Url::to(['contact/logs'], true); ?>">Logs</a>
												</li>
												<!--end::Nav item-->
											</ul>
											<!--begin::Navs-->
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5">
											<a href="<?php echo Url::to(['contact/index'], true); ?>" class="menu-link px-5">My Profile</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-5">
										...
										<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
											...
											<div class="menu-sub menu-sub-dropdown w-175px py-4">
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="<?php echo Url::to(['contact/referrals'], true); ?>" class="menu-link px-5">Referrals</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="<?php echo Url::to(['contact/billing'], true); ?>" class="menu-link px-5">Billing</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
