...
<div class="m-0">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4" data-kt-menu="true">
        ...
        <div class="menu-item px-3">
            <a href="<?= Url::to(['contact/setlang', 'lang' => 'en']) ?>" class="menu-link d-flex px-5" data-kt-lang="English">
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="<?= Url::to(['contact/setlang', 'lang' => 'id']) ?>" class="menu-link d-flex px-5" data-kt-lang="Indonesia">
                <span class="symbol symbol-20px me-4">
