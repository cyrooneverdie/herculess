...
if ("$module/$type" == "purchase/return") {
    $urladd = Url::to(['createreturn', 'module' => $module, 'type' => $type]);
} elseif ("$module/$type" == "sales/return") {
    $urladd = Url::to(['createreturnstock', 'module' => $module, 'type' => $type]);
}
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select id="contactSelect" class="form-select contact"
                                            name="contact">
        ...
        <table class="table align-left table-row-dashed fs-6 gy-5" id="datatable">
            <thead>
                <tr class="text-start bg-gray-100 fs-6 text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="text-center min-w-150px"><?= Yii::$app->lang->t('tran', 'returnstatus') ?></th>
                    ...
                    <th class="text-start min-w-150px">Return Date</th>
...
<script>
    ...
    function addNestedDropdown() {
        $(document).on('click', '.neo-orba', function (e) {
            ...
            $('button.neo-orba').html('<i class="fa-solid fa-caret-right"></i>'); // Reset semua tombol
                        ...
                        <div class="m-3 row">
                           ...
                           <div class="col-md-6 ps-3">
                            <div class="d-flex align-items-center gap-2 mb-4">
                                ...
                                <h6 class="fw-bold mb-0 text-gray-700 fs-7 text-uppercase ls-1">Status Pengembalian</h6>
                            </div>
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return row.return + row.return2 || '0';
                        }
                    },
                    {
                        data: null,
                        render: function (data, type, row) {
                            return `
                               <div class="dropdown text-center dropend">
                                <a class="dropdown-item text-hover-primary btn-variant-deli-rtn"
                                    href="<?= Url::to(['variant/variantdeli']) ?>?refid=${row.trandetailid}"
                                    data-bs-toggle="modal"
                                    data-bs-target="#modal_list_track">
    ...
    $(document).ready(function () {
        ...
        $("#datatable").DataTable({
            ...
            },
            {
                render: function (data, type, row) {
                    ...
                    <div class="dropdown text-center dropend">
                        ...
                        <li>
                            <a class="dropdown-item text-hover-success btn-edit-return" data-tranid="${row.tranid}"
                                href="<?= Url::to(['tran/updatedeli']) ?>?id=${row.tranid}"
                                data-bs-toggle="modal"
                                data-bs-target="#modal_form_tran">
                            <i class="fa-solid fa-pen-to-square m-0"></i> Update
                            </a>
                        </li>
                        <li>
            ...
            },
            {
                ...
                className: "text-center",
                render: function (data, type, row) {
                    let totalScan = parseFloat(row.item_count || 0);
                    let totalHarusReturn = parseFloat(row.amount_ret || 0);
                    let sisa = totalHarusReturn - totalScan;
                    ...
                    if (finish && totalScan < totalHarusReturn) {
                        badgeClass = 'bg-light-info text-info';
                        badgeText = `<?= Yii::$app->lang->t('extra', 'complete') ?> (${totalScan}/${totalHarusReturn})`;
                    } else if (totalScan === 0 && totalHarusReturn > 0) {
                        badgeClass = 'bg-light-danger text-danger';
                        badgeText = `<?= Yii::$app->lang->t('tran', 'notstarted') ?> (${totalHarusReturn} items) `;
                    } else if (totalScan >= totalHarusReturn && totalHarusReturn > 0) {
                        badgeClass = 'bg-light-success text-success';
                        badgeText = `<?= Yii::$app->lang->t('extra', 'complete') ?> (${totalScan}/${totalHarusReturn})`;
                    } else if (totalScan < totalHarusReturn) {
                ...
                render: function (data, type, row) {
                    ...
                    if (statusInfo[data]) {
                        ...
                        if (data == 0) {
                            ...
                            `;
                        } else if (data == 1 && row.statuspro_ord !== '15') {
                            statusOptions = `
                                    <li>
                                        <a class="dropdown-item items update-status d-flex align-items-center" href="#" data-id="${row.tranid}" data-status="5">
                                            <i class="fas fa-ban text-warning me-2"></i> Cancel
